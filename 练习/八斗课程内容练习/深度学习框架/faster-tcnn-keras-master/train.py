...
from utils2.utils import BBoxUtility
from utils2.roi_helpers import calc_iou
...
if __name__ == "__main__":
    ...
    annotation_path = '../../../../../data/faster-rcnn-keras-master/2007_train.txt'

    model_rpn, model_classifier, model_all = get_model(config, NUM_CLASSES)
    base_net_weights = "../../../../../data/faster-rcnn-keras-master/model_data/voc_weights.h5"
